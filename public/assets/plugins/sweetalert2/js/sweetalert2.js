!(function (t, e) {
    ...
    kt = function (t) {
      var e,
        ...
        a =
          ...
          bt([document.documentElement, document.body], [J['no-backdrop'], J['toast-shown'], J['has-column']]),
          !0);
      pt()
  ...
  function Et(t, e) {
    ...
    i &&
      ...
      (n = e.position) in J
        ? vt(o, J[n])
        : (W('The "position" parameter is not valid, defaulting to "center"'), vt(o, J.center)),
      (n = i),
    ...
    jn = Object.freeze({
      ...
      resetValidationMessage: function () {
        ...
        t.validationMessage && at(t.validationMessage),
          (t = this.getInput()) &&
            (t.removeAttribute('aria-invalid'), t.removeAttribute('aria-describedBy'), bt(t, J.inputerror));
      },
